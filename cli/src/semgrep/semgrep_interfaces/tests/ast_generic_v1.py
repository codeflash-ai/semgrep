...
def _atd_bad_json(expected_type: str, json_value: Any) -> NoReturn:
    ...
    truncated_value_str = value_str[:200] + "…" if len(value_str) > 200 else value_str

    raise ValueError(
        f"incompatible JSON value where"
        f" type '{expected_type}' was expected: '{truncated_value_str}'"
    )
...
class IncrDecr_:
    ...
    def to_json(self) -> Any:
        return [
            ...
            (
                lambda x: (
                    [(lambda x: x.to_json())(x[0]), (lambda x: x.to_json())(x[1])]
                ...
                return cls(
                    IncrDecr_(
                        (
                            lambda x: (
                                (
                                    IncrDecr.from_json(x[0]),
                                    PrefixPostfix.from_json(x[1]),
                                )
                                if isinstance(x, list) and len(x) == 2
...
class TokenLocation:
    ...
    def from_json(cls, x: Any) -> "TokenLocation":
        if isinstance(x, dict):
            return cls(
                str=(
                    _atd_read_string(x["str"])
                    if "str" in x
                    else _atd_missing_json_field("TokenLocation", "str")
                ),
                charpos=(
                    _atd_read_int(x["charpos"])
                    if "charpos" in x
                    else _atd_missing_json_field("TokenLocation", "charpos")
                ),
                line=(
                    _atd_read_int(x["line"])
                    if "line" in x
                    else _atd_missing_json_field("TokenLocation", "line")
                ),
                column=(
                    _atd_read_int(x["column"])
                    if "column" in x
                    else _atd_missing_json_field("TokenLocation", "column")
                ),
                filename=(
                    _atd_read_string(x["filename"])
                    if "filename" in x
                    else _atd_missing_json_field("TokenLocation", "filename")
                ),
            )
        else:
...
class BoolWrap:
    ...
    def from_json(cls, x: Any) -> "BoolWrap":
        return cls(
            (
                lambda x: (
                    (_atd_read_bool(x[0]), Tok.from_json(x[1]))
                    if isinstance(x, list) and len(x) == 2
                    else _atd_bad_json("array of length 2", x)
                )
            )(x)
    ...
    def to_json(self) -> Any:
        return (
            lambda x: (
                [_atd_write_bool(x[0]), (lambda x: x.to_json())(x[1])]
                if isinstance(x, tuple) and len(x) == 2
                else _atd_bad_python("tuple of length 2", x)
            )
        )(self.value)
...
class ClassKindWrap:
    ...
    def from_json(cls, x: Any) -> "ClassKindWrap":
        return cls(
            (
                lambda x: (
                    (ClassKind.from_json(x[0]), Tok.from_json(x[1]))
                    if isinstance(x, list) and len(x) == 2
                    else _atd_bad_json("array of length 2", x)
                )
            )(x)
...
class FloatNullableWrap:
    ...
    def from_json(cls, x: Any) -> "FloatNullableWrap":
        return cls(
            (
                lambda x: (
                    (_atd_read_nullable(_atd_read_float)(x[0]), Tok.from_json(x[1]))
                    if isinstance(x, list) and len(x) == 2
                    else _atd_bad_json("array of length 2", x)
                )
            )(x)
    ...
    def to_json(self) -> Any:
        return (
            lambda x: (
                [
                    _atd_write_nullable(_atd_write_float)(x[0]),
                    (lambda x: x.to_json())(x[1]),
                ]
                if isinstance(x, tuple) and len(x) == 2
                else _atd_bad_python("tuple of length 2", x)
            )
...
class FunctionKindWrap:
    ...
    def from_json(cls, x: Any) -> "FunctionKindWrap":
        return cls(
            (
                lambda x: (
                    (FunctionKind.from_json(x[0]), Tok.from_json(x[1]))
                    if isinstance(x, list) and len(x) == 2
                    else _atd_bad_json("array of length 2", x)
                )
            )(x)
...
class IntNullableWrap:
    ...
    def from_json(cls, x: Any) -> "IntNullableWrap":
        return cls(
            (
                lambda x: (
                    (_atd_read_nullable(_atd_read_int)(x[0]), Tok.from_json(x[1]))
                    if isinstance(x, list) and len(x) == 2
                    else _atd_bad_json("array of length 2", x)
                )
            )(x)
    ...
    def to_json(self) -> Any:
        return (
            lambda x: (
                [
                    _atd_write_nullable(_atd_write_int)(x[0]),
                    (lambda x: x.to_json())(x[1]),
                ]
                if isinstance(x, tuple) and len(x) == 2
                else _atd_bad_python("tuple of length 2", x)
...
class IntWrap:
    ...
    def from_json(cls, x: Any) -> "IntWrap":
        return cls(
            (
                lambda x: (
                    (_atd_read_int(x[0]), Tok.from_json(x[1]))
                    if isinstance(x, list) and len(x) == 2
                    else _atd_bad_json("array of length 2", x)
                )
            )(x)
    ...
    def to_json(self) -> Any:
        return (
            lambda x: (
                [_atd_write_int(x[0]), (lambda x: x.to_json())(x[1])]
                if isinstance(x, tuple) and len(x) == 2
                else _atd_bad_python("tuple of length 2", x)
            )
        )(self.value)
...
class KeywordAttributeWrap:
    ...
    def from_json(cls, x: Any) -> "KeywordAttributeWrap":
        return cls(
            (
                lambda x: (
                    (KeywordAttribute.from_json(x[0]), Tok.from_json(x[1]))
                    if isinstance(x, list) and len(x) == 2
                    else _atd_bad_json("array of length 2", x)
                )
            )(x)
...
class OperatorWrap:
    ...
    def from_json(cls, x: Any) -> "OperatorWrap":
        return cls(
            (
                lambda x: (
                    (Operator.from_json(x[0]), Tok.from_json(x[1]))
                    if isinstance(x, list) and len(x) == 2
                    else _atd_bad_json("array of length 2", x)
                )
            )(x)
...
class SpecialWrap:
    ...
    def from_json(cls, x: Any) -> "SpecialWrap":
        return cls(
            (
                lambda x: (
                    (Special.from_json(x[0]), Tok.from_json(x[1]))
                    if isinstance(x, list) and len(x) == 2
                    else _atd_bad_json("array of length 2", x)
                )
            )(x)
...
class StringWrap:
    ...
    def from_json(cls, x: Any) -> "StringWrap":
        return cls(
            (
                lambda x: (
                    (_atd_read_string(x[0]), Tok.from_json(x[1]))
                    if isinstance(x, list) and len(x) == 2
                    else _atd_bad_json("array of length 2", x)
                )
            )(x)
    ...
    def to_json(self) -> Any:
        return (
            lambda x: (
                [_atd_write_string(x[0]), (lambda x: x.to_json())(x[1])]
                if isinstance(x, tuple) and len(x) == 2
                else _atd_bad_python("tuple of length 2", x)
            )
        )(self.value)
...
class StringWrapBracket:
        ...
        return cls(
            (
                lambda x: (
                    (
                        Tok.from_json(x[0]),
                        StringWrap.from_json(x[1]),
                        Tok.from_json(x[2]),
                    )
                    if isinstance(x, list) and len(x) == 3
                    else _atd_bad_json("array of length 3", x)
                )
            )(x)
        )
    ...
    def to_json(self) -> Any:
        return (
            lambda x: (
                [
                    (lambda x: x.to_json())(x[0]),
                    (lambda x: x.to_json())(x[1]),
                    (lambda x: x.to_json())(x[2]),
                ]
                if isinstance(x, tuple) and len(x) == 3
                else _atd_bad_python("tuple of length 3", x)
            )
        )(self.value)
        ...
        return [
            ...
            (
                lambda x: (
                    [
                        (lambda x: x.to_json())(x[0]),
                        _atd_write_nullable((lambda x: x.to_json()))(x[1]),
                    ]
                    if isinstance(x, tuple) and len(x) == 2
                    else _atd_bad_python("tuple of length 2", x)
                )
...
class Literal:
    ...
    value: Union[
        Bool, Int, Float, Char, String, Regexp, Atom, Unit, Null, Undefined, Imag, Ratio
    ]
                ...
                return cls(
                    Regexp(
                        (
                            lambda x: (
                                (
                                    StringWrapBracket.from_json(x[0]),
                                    _atd_read_nullable(StringWrap.from_json)(x[1]),
                                )
                                if isinstance(x, list) and len(x) == 2
                                else _atd_bad_json("array of length 2", x)
                            )
            ...
            if cons == "Atom":
                return cls(
                    Atom(
                        (
                            lambda x: (
                                (Tok.from_json(x[0]), StringWrap.from_json(x[1]))
                                if isinstance(x, list) and len(x) == 2
                                else _atd_bad_json("array of length 2", x)
                            )
                        )(x[1])
...
class ResolvedNameKind:
    ...
    value: Union[
        Global, Local, Param, ImportedEntity, ImportedModule, OtherResolvedNameKind
    ]
...
class ResolvedName:
    ...
    def from_json(cls, x: Any) -> "ResolvedName":
        return cls(
            (
                lambda x: (
                    (ResolvedNameKind.from_json(x[0]), Sid.from_json(x[1]))
                    if isinstance(x, list) and len(x) == 2
                    else _atd_bad_json("array of length 2", x)
                )
            )(x)
...
class VarianceWrap:
    ...
    def from_json(cls, x: Any) -> "VarianceWrap":
        return cls(
            (
                lambda x: (
                    (Variance.from_json(x[0]), Tok.from_json(x[1]))
                    if isinstance(x, list) and len(x) == 2
                    else _atd_bad_json("array of length 2", x)
                )
            )(x)
            ...
            (
                lambda x: (
                    [
                        ...
                        (lambda x: x.to_json())(x[1]),
                        (lambda x: x.to_json())(x[2]),
                        (lambda x: x.to_json())(x[3]),
                    ]
                    if isinstance(x, tuple) and len(x) == 4
                    else _atd_bad_python("tuple of length 4", x)
                )
            )(self.value),
        ]
                    ...
                    XmlClassic(
                        (
                            lambda x: (
                                ...
                                else _atd_bad_json("array of length 4", x)
                            )
                        )(x[1])
                    )
                )
            ...
            if cons == "XmlFragment":
                return cls(
                    XmlFragment(
                        (
                            lambda x: (
                                (Tok.from_json(x[0]), Tok.from_json(x[1]))
                                if isinstance(x, list) and len(x) == 2
                                else _atd_bad_json("array of length 2", x)
                            )
                        )(x[1])
        ...
        return cls(
            (
                lambda x: (
                    (
                        Tok.from_json(x[0]),
                        _atd_read_list(Argument.from_json)(x[1]),
                        Tok.from_json(x[2]),
                    )
                    if isinstance(x, list) and len(x) == 3
                    else _atd_bad_json("array of length 3", x)
                ...
                lambda x: (
                    (
                        ...
                        (
                            lambda x: (
                                (
                                    _atd_read_nullable(Expr.from_json)(x[0]),
                                    _atd_read_nullable(Expr.from_json)(x[1]),
                                    _atd_read_nullable(Expr.from_json)(x[2]),
                                )
                                if isinstance(x, list) and len(x) == 3
                                else _atd_bad_json("array of length 3", x)
                            )
            ...
            lambda x: (
                [
                    ...
                    (
                        lambda x: (
                            [
                                _atd_write_nullable((lambda x: x.to_json()))(x[0]),
                                _atd_write_nullable((lambda x: x.to_json()))(x[1]),
                                _atd_write_nullable((lambda x: x.to_json()))(x[2]),
                            ]
                            if isinstance(x, tuple) and len(x) == 3
                            else _atd_bad_python("tuple of length 3", x)
                        )
                    ...
                    (
                        ...
                        _atd_read_list(
                            (
                                lambda x: (
                                    (
                                        DottedIdent.from_json(x[0]),
                                        Pattern.from_json(x[1]),
                                    )
                                    if isinstance(x, list) and len(x) == 2
                                    else _atd_bad_json("array of length 2", x)
                                )
...
class ExprBracket:
    ...
    def from_json(cls, x: Any) -> "ExprBracket":
        return cls(
            (
                lambda x: (
                    (Tok.from_json(x[0]), Expr.from_json(x[1]), Tok.from_json(x[2]))
                    if isinstance(x, list) and len(x) == 3
                    else _atd_bad_json("array of length 3", x)
                )
            )(x)
        ...
        return cls(
            (
                lambda x: (
                    (
                        Tok.from_json(x[0]),
                        _atd_read_list(Expr.from_json)(x[1]),
                        Tok.from_json(x[2]),
                    )
                    if isinstance(x, list) and len(x) == 3
                    else _atd_bad_json("array of length 3", x)
        ...
        return cls(
            (
                lambda x: (
                    (
                        Tok.from_json(x[0]),
                        _atd_read_list(Field.from_json)(x[1]),
                        Tok.from_json(x[2]),
                    )
                    if isinstance(x, list) and len(x) == 3
                    else _atd_bad_json("array of length 3", x)
        ...
        return cls(
            (
                lambda x: (
                    (
                        Tok.from_json(x[0]),
                        _atd_read_list(Pattern.from_json)(x[1]),
                        Tok.from_json(x[2]),
                    )
                    if isinstance(x, list) and len(x) == 3
                    else _atd_bad_json("array of length 3", x)
        ...
        return cls(
            (
                lambda x: (
                    (
                        Tok.from_json(x[0]),
                        _atd_read_list(Stmt.from_json)(x[1]),
                        Tok.from_json(x[2]),
                    )
                    if isinstance(x, list) and len(x) == 3
                    else _atd_bad_json("array of length 3", x)
        ...
        return cls(
            (
                lambda x: (
                    (
                        Tok.from_json(x[0]),
                        _atd_read_list(TypeArgument.from_json)(x[1]),
                        Tok.from_json(x[2]),
                    )
                    if isinstance(x, list) and len(x) == 3
                    else _atd_bad_json("array of length 3", x)
        ...
        return cls(
            (
                lambda x: (
                    (
                        Tok.from_json(x[0]),
                        _atd_read_list(Type.from_json)(x[1]),
                        Tok.from_json(x[2]),
                    )
                    if isinstance(x, list) and len(x) == 3
                    else _atd_bad_json("array of length 3", x)
...
class Alias:
    ...
    def from_json(cls, x: Any) -> "Alias":
        return cls(
            (
                lambda x: (
                    (Ident.from_json(x[0]), IdInfo.from_json(x[1]))
                    if isinstance(x, list) and len(x) == 2
                    else _atd_bad_json("array of length 2", x)
                )
            )(x)
...
class Anys:
    ...
    def to_json(self) -> Any:
        return [
            ...
            (
                lambda x: (
                    [_atd_write_list((lambda x: x.to_json()))(x[0])]
                    if isinstance(x, tuple) and len(x) == 1
                    else _atd_bad_python("tuple of length 1", x)
                )
            )(self.value),
        ]
            ...
            if cons == "Anys":
                return cls(
                    Anys(
                        (
                            lambda x: (
                                (_atd_read_list(Any_.from_json)(x[0]))
                                if isinstance(x, list) and len(x) == 1
                                else _atd_bad_json("array of length 1", x)
                            )
                        )(x[1])
                    )
                )
            ...
            if cons == "ArgKwd":
                return cls(
                    ArgKwd(
                        (
                            lambda x: (
                                (Ident.from_json(x[0]), Expr.from_json(x[1]))
                                if isinstance(x, list) and len(x) == 2
                                else _atd_bad_json("array of length 2", x)
                            )
                        )(x[1])
                ...
                return cls(
                    OtherArg(
                        (
                            lambda x: (
                                (
                                    TodoKind.from_json(x[0]),
                                    _atd_read_list(Any_.from_json)(x[1]),
                                )
                                if isinstance(x, list) and len(x) == 2
                                else _atd_bad_json("array of length 2", x)
                            )
            ...
            if cons == "Case":
                return cls(
                    Case_(
                        (
                            lambda x: (
                                (Tok.from_json(x[0]), Pattern.from_json(x[1]))
                                if isinstance(x, list) and len(x) == 2
                                else _atd_bad_json("array of length 2", x)
                            )
                        )(x[1])
            ...
            if cons == "CaseEqualExpr":
                return cls(
                    CaseEqualExpr(
                        (
                            lambda x: (
                                (Tok.from_json(x[0]), Expr.from_json(x[1]))
                                if isinstance(x, list) and len(x) == 2
                                else _atd_bad_json("array of length 2", x)
                            )
                        )(x[1])
                ...
                return cls(
                    CasesAndBody(
                        (
                            lambda x: (
                                (
                                    _atd_read_list(Case.from_json)(x[0]),
                                    Stmt.from_json(x[1]),
                                )
                                if isinstance(x, list) and len(x) == 2
                                else _atd_bad_json("array of length 2", x)
...
class ClassDefinition:
    ...
    def from_json(cls, x: Any) -> "ClassDefinition":
        if isinstance(x, dict):
            return cls(
                ckind=(
                    ClassKindWrap.from_json(x["ckind"])
                    if "ckind" in x
                    else _atd_missing_json_field("ClassDefinition", "ckind")
                ),
                cextends=(
                    _atd_read_list(ClassParent.from_json)(x["cextends"])
                    if "cextends" in x
                    else _atd_missing_json_field("ClassDefinition", "cextends")
                ),
                cimplements=(
                    _atd_read_list(Type.from_json)(x["cimplements"])
                    if "cimplements" in x
                    else _atd_missing_json_field("ClassDefinition", "cimplements")
                ),
                cmixins=(
                    _atd_read_list(Type.from_json)(x["cmixins"])
                    if "cmixins" in x
                    else _atd_missing_json_field("ClassDefinition", "cmixins")
                ),
                cparams=(
                    Parameters.from_json(x["cparams"])
                    if "cparams" in x
                    else _atd_missing_json_field("ClassDefinition", "cparams")
                ),
                cbody=(
                    FieldListBracket.from_json(x["cbody"])
                    if "cbody" in x
                    else _atd_missing_json_field("ClassDefinition", "cbody")
                ),
            )
        else:
        ...
        return cls(
            (
                lambda x: (
                    (
                        Type.from_json(x[0]),
                        _atd_read_nullable(Arguments.from_json)(x[1]),
                    )
                    if isinstance(x, list) and len(x) == 2
                    else _atd_bad_json("array of length 2", x)
                )
...
class Comprehension:
    ...
    def from_json(cls, x: Any) -> "Comprehension":
        return cls(
            (
                lambda x: (
                    (Expr.from_json(x[0]), _atd_read_list(ForOrIfComp.from_json)(x[1]))
                    if isinstance(x, list) and len(x) == 2
                    else _atd_bad_json("array of length 2", x)
                )
            )(x)
...
class Definition:
    ...
    def from_json(cls, x: Any) -> "Definition":
        return cls(
            (
                lambda x: (
                    (Entity.from_json(x[0]), DefinitionKind.from_json(x[1]))
                    if isinstance(x, list) and len(x) == 2
                    else _atd_bad_json("array of length 2", x)
                )
            )(x)
                        ...
                        _atd_write_list(
                            (
                                lambda x: (
                                    [
                                        (lambda x: x.to_json())(x[0]),
                                        _atd_write_nullable((lambda x: x.to_json()))(
                                            x[1]
                                        ),
                                    ]
                                    if isinstance(x, tuple) and len(x) == 2
...
class Directive:
    ...
    value: Union[
        ImportFrom, ImportAs, ImportAll, Package, PackageEnd, Pragma, OtherDirective
    ]
                    ...
                    ImportFrom(
                        (
                            lambda x: (
                                (
                                    Tok.from_json(x[0]),
                                    ModuleName.from_json(x[1]),
                                    _atd_read_list(
                                        (
                                            lambda x: (
                                                (
                                                    Ident.from_json(x[0]),
                                                    _atd_read_nullable(Alias.from_json)(
                                                        x[1]
                                                    ),
                                                )
                                                if isinstance(x, list) and len(x) == 2
                        ...
                        (
                            lambda x: (
                                (
                                    Tok.from_json(x[0]),
                                    ModuleName.from_json(x[1]),
                                    _atd_read_nullable(Alias.from_json)(x[2]),
                                )
                                if isinstance(x, list) and len(x) == 3
                                else _atd_bad_json("array of length 3", x)
                            )
            ...
            if cons == "Package":
                return cls(
                    Package(
                        (
                            lambda x: (
                                (Tok.from_json(x[0]), DottedIdent.from_json(x[1]))
                                if isinstance(x, list) and len(x) == 2
                                else _atd_bad_json("array of length 2", x)
                            )
                        )(x[1])
...
class Entity:
    ...
    def from_json(cls, x: Any) -> "Entity":
        if isinstance(x, dict):
            return cls(
                name=(
                    EntityName.from_json(x["name"])
                    if "name" in x
                    else _atd_missing_json_field("Entity", "name")
                ),
                attrs=(
                    _atd_read_list(Attribute.from_json)(x["attrs"])
                    if "attrs" in x
                    else _atd_missing_json_field("Entity", "attrs")
                ),
                tparams=(
                    TypeParameters.from_json(x["tparams"])
                    if "tparams" in x
                    else _atd_missing_json_field("Entity", "tparams")
                ),
            )
        else:
...
class EnumEntryDefinition:
    ...
    def from_json(cls, x: Any) -> "EnumEntryDefinition":
        if isinstance(x, dict):
            return cls(
                ee_args=(
                    _atd_read_nullable(Arguments.from_json)(x["ee_args"])
                    if "ee_args" in x
                    else _atd_missing_json_field("EnumEntryDefinition", "ee_args")
                ),
                ee_body=(
                    _atd_read_nullable(FieldListBracket.from_json)(x["ee_body"])
                    if "ee_body" in x
                    else _atd_missing_json_field("EnumEntryDefinition", "ee_body")
                ),
            )
        else:
                ...
                return cls(
                    Container(
                        (
                            lambda x: (
                                (
                                    ContainerOperator.from_json(x[0]),
                                    ExprListBracket.from_json(x[1]),
                                )
                                if isinstance(x, list) and len(x) == 2
                                else _atd_bad_json("array of length 2", x)
                            )
                    ...
                    Comprehension_(
                        (
                            lambda x: (
                                (
                                    ContainerOperator.from_json(x[0]),
                                    ComprehensionBracket.from_json(x[1]),
                                )
                                if isinstance(x, list) and len(x) == 2
                                else _atd_bad_json("array of length 2", x)
                            )
            ...
            if cons == "Constructor":
                return cls(
                    Constructor(
                        (
                            lambda x: (
                                (Name.from_json(x[0]), ExprListBracket.from_json(x[1]))
                                if isinstance(x, list) and len(x) == 2
                                else _atd_bad_json("array of length 2", x)
                            )
                        )(x[1])
            ...
            if cons == "Call":
                return cls(
                    Call(
                        (
                            lambda x: (
                                (Expr.from_json(x[0]), Arguments.from_json(x[1]))
                                if isinstance(x, list) and len(x) == 2
                                else _atd_bad_json("array of length 2", x)
                            )
                        )(x[1])
            ...
            if cons == "LetPattern":
                return cls(
                    LetPattern(
                        (
                            lambda x: (
                                (Pattern.from_json(x[0]), Expr.from_json(x[1]))
                                if isinstance(x, list) and len(x) == 2
                                else _atd_bad_json("array of length 2", x)
                            )
                        )(x[1])
            ...
            if cons == "ArrayAccess":
                return cls(
                    ArrayAccess(
                        (
                            lambda x: (
                                (Expr.from_json(x[0]), ExprBracket.from_json(x[1]))
                                if isinstance(x, list) and len(x) == 2
                                else _atd_bad_json("array of length 2", x)
                            )
                        )(x[1])
            ...
            if cons == "SliceAccess":
                return cls(
                    SliceAccess(
                        (
                            lambda x: (
                                (Expr.from_json(x[0]), Bracket0ecc50b.from_json(x[1]))
                                if isinstance(x, list) and len(x) == 2
                                else _atd_bad_json("array of length 2", x)
                            )
                        )(x[1])
            ...
            if cons == "Cast":
                return cls(
                    Cast(
                        (
                            lambda x: (
                                (Type.from_json(x[0]), Expr.from_json(x[1]))
                                if isinstance(x, list) and len(x) == 2
                                else _atd_bad_json("array of length 2", x)
                            )
                        )(x[1])
...
class Finally:
    ...
    def from_json(cls, x: Any) -> "Finally":
        return cls(
            (
                lambda x: (
                    (Tok.from_json(x[0]), Stmt.from_json(x[1]))
                    if isinstance(x, list) and len(x) == 2
                    else _atd_bad_json("array of length 2", x)
                )
            )(x)
...
class ForEach:
    ...
    def from_json(cls, x: Any) -> "ForEach":
        return cls(
            (
                lambda x: (
                    (Pattern.from_json(x[0]), Tok.from_json(x[1]), Expr.from_json(x[2]))
                    if isinstance(x, list) and len(x) == 3
                    else _atd_bad_json("array of length 3", x)
                )
            )(x)
                ...
                return cls(
                    ForClassic(
                        (
                            lambda x: (
                                (
                                    _atd_read_list(ForVarOrExpr.from_json)(x[0]),
                                    _atd_read_nullable(Expr.from_json)(x[1]),
                                    _atd_read_nullable(Expr.from_json)(x[2]),
                                )
                                if isinstance(x, list) and len(x) == 3
                ...
                return cls(
                    ForInitVar(
                        (
                            lambda x: (
                                (
                                    Entity.from_json(x[0]),
                                    VariableDefinition.from_json(x[1]),
                                )
                                if isinstance(x, list) and len(x) == 2
                                else _atd_bad_json("array of length 2", x)
                            )
...
class FunctionDefinition:
    ...
    def from_json(cls, x: Any) -> "FunctionDefinition":
        if isinstance(x, dict):
            return cls(
                fkind=(
                    FunctionKindWrap.from_json(x["fkind"])
                    if "fkind" in x
                    else _atd_missing_json_field("FunctionDefinition", "fkind")
                ),
                fparams=(
                    Parameters.from_json(x["fparams"])
                    if "fparams" in x
                    else _atd_missing_json_field("FunctionDefinition", "fparams")
                ),
                frettype=(
                    _atd_read_nullable(Type.from_json)(x["frettype"])
                    if "frettype" in x
                    else _atd_missing_json_field("FunctionDefinition", "frettype")
                ),
                fbody=(
                    FunctionBody.from_json(x["fbody"])
                    if "fbody" in x
                    else _atd_missing_json_field("FunctionDefinition", "fbody")
                ),
            )
        else:
...
class IdInfo:
    ...
    def from_json(cls, x: Any) -> "IdInfo":
        if isinstance(x, dict):
            return cls(
                id_resolved=(
                    ResolvedName.from_json(x["id_resolved"])
                    if "id_resolved" in x
                    else None
                ),
                id_type=Type.from_json(x["id_type"]) if "id_type" in x else None,
                id_svalue=(
                    Svalue.from_json(x["id_svalue"]) if "id_svalue" in x else None
                ),
            )
        else:
...
class MacroDefinition:
    ...
    def from_json(cls, x: Any) -> "MacroDefinition":
        if isinstance(x, dict):
            return cls(
                macroparams=(
                    _atd_read_list(Ident.from_json)(x["macroparams"])
                    if "macroparams" in x
                    else _atd_missing_json_field("MacroDefinition", "macroparams")
                ),
                macrobody=(
                    _atd_read_list(Any_.from_json)(x["macrobody"])
                    if "macrobody" in x
                    else _atd_missing_json_field("MacroDefinition", "macrobody")
                ),
            )
        else:
...
class ModuleDefinition:
    ...
    def from_json(cls, x: Any) -> "ModuleDefinition":
        if isinstance(x, dict):
            return cls(
                mbody=(
                    ModuleDefinitionKind.from_json(x["mbody"])
                    if "mbody" in x
                    else _atd_missing_json_field("ModuleDefinition", "mbody")
                ),
            )
        else:
                ...
                return cls(
                    ModuleStruct(
                        (
                            lambda x: (
                                (
                                    _atd_read_nullable(DottedIdent.from_json)(x[0]),
                                    _atd_read_list(Item.from_json)(x[1]),
                                )
                                if isinstance(x, list) and len(x) == 2
                                else _atd_bad_json("array of length 2", x)
                            )
            ...
            if cons == "OrUnion":
                return cls(
                    OrUnion(
                        (
                            lambda x: (
                                (Ident.from_json(x[0]), Type.from_json(x[1]))
                                if isinstance(x, list) and len(x) == 2
                                else _atd_bad_json("array of length 2", x)
                            )
                        )(x[1])
            ...
            if cons == "ParamRest":
                return cls(
                    ParamRest(
                        (
                            lambda x: (
                                (Tok.from_json(x[0]), ParameterClassic.from_json(x[1]))
                                if isinstance(x, list) and len(x) == 2
                                else _atd_bad_json("array of length 2", x)
                            )
                        )(x[1])
...
class ParameterClassic:
    ...
    def from_json(cls, x: Any) -> "ParameterClassic":
        if isinstance(x, dict):
            return cls(
                pname=(
                    _atd_read_nullable(Ident.from_json)(x["pname"])
                    if "pname" in x
                    else _atd_missing_json_field("ParameterClassic", "pname")
                ),
                ptype=(
                    _atd_read_nullable(Type.from_json)(x["ptype"])
                    if "ptype" in x
                    else _atd_missing_json_field("ParameterClassic", "ptype")
                ),
                pdefault=(
                    _atd_read_nullable(Expr.from_json)(x["pdefault"])
                    if "pdefault" in x
                    else _atd_missing_json_field("ParameterClassic", "pdefault")
                ),
                pattrs=(
                    _atd_read_list(Attribute.from_json)(x["pattrs"])
                    if "pattrs" in x
                    else _atd_missing_json_field("ParameterClassic", "pattrs")
                ),
                pinfo=(
                    IdInfo.from_json(x["pinfo"])
                    if "pinfo" in x
                    else _atd_missing_json_field("ParameterClassic", "pinfo")
                ),
            )
        else:
            ...
            if cons == "PatKeyVal":
                return cls(
                    PatKeyVal(
                        (
                            lambda x: (
                                (Pattern.from_json(x[0]), Pattern.from_json(x[1]))
                                if isinstance(x, list) and len(x) == 2
                                else _atd_bad_json("array of length 2", x)
                            )
                        )(x[1])
            ...
            if cons == "PatTyped":
                return cls(
                    PatTyped(
                        (
                            lambda x: (
                                (Pattern.from_json(x[0]), Type.from_json(x[1]))
                                if isinstance(x, list) and len(x) == 2
                                else _atd_bad_json("array of length 2", x)
                            )
                        )(x[1])
                ...
                return cls(
                    PatAs(
                        (
                            lambda x: (
                                (
                                    Pattern.from_json(x[0]),
                                    (
                                        lambda x: (
                                            (
                                                Ident.from_json(x[0]),
                                                IdInfo.from_json(x[1]),
                                            )
                                            if isinstance(x, list) and len(x) == 2
                                            else _atd_bad_json("array of length 2", x)
                                        )
                ...
                name_last=(
                    (
                        lambda x: (
                            (
                                Ident.from_json(x[0]),
                                _atd_read_nullable(TypeArguments.from_json)(x[1]),
                            )
                            if isinstance(x, list) and len(x) == 2
                            else _atd_bad_json("array of length 2", x)
                        )
                    ...
                    if "name_last" in x
                    else _atd_missing_json_field("QualifiedInfo", "name_last")
                ),
                name_info=(
                    IdInfo.from_json(x["name_info"])
                    if "name_info" in x
                    else _atd_missing_json_field("QualifiedInfo", "name_info")
                ),
                name_middle=(
                    Qualifier.from_json(x["name_middle"])
                    if "name_middle" in x
                    else None
                ),
                        ...
                        _atd_read_list(
                            (
                                lambda x: (
                                    (
                                        Ident.from_json(x[0]),
                                        _atd_read_nullable(TypeArguments.from_json)(
                                            x[1]
                                        ),
                                    )
                                    if isinstance(x, list) and len(x) == 2
            ...
            if cons == "QExpr":
                return cls(
                    QExpr(
                        (
                            lambda x: (
                                (Expr.from_json(x[0]), Tok.from_json(x[1]))
                                if isinstance(x, list) and len(x) == 2
                                else _atd_bad_json("array of length 2", x)
                            )
                        )(x[1])
            ...
            (
                lambda x: (
                    [
                        ...
                        (lambda x: x.to_json())(x[1]),
                        (lambda x: x.to_json())(x[2]),
                        _atd_write_nullable((lambda x: x.to_json()))(x[3]),
                    ]
                    if isinstance(x, tuple) and len(x) == 4
                    else _atd_bad_python("tuple of length 4", x)
                )
            ...
            (
                lambda x: (
                    [
                        (lambda x: x.to_json())(x[0]),
                        _atd_write_nullable((lambda x: x.to_json()))(x[1]),
                        _atd_write_list((lambda x: x.to_json()))(x[2]),
                    ]
                    if isinstance(x, tuple) and len(x) == 3
                    else _atd_bad_python("tuple of length 3", x)
                )
            ...
            if cons == "ExprStmt":
                return cls(
                    ExprStmt(
                        (
                            lambda x: (
                                (Expr.from_json(x[0]), Sc.from_json(x[1]))
                                if isinstance(x, list) and len(x) == 2
                                else _atd_bad_json("array of length 2", x)
                            )
                        )(x[1])
                    ...
                    If(
                        (
                            lambda x: (
                                (
                                    Tok.from_json(x[0]),
                                    Condition.from_json(x[1]),
                                    Stmt.from_json(x[2]),
                                    _atd_read_nullable(Stmt.from_json)(x[3]),
                                )
                                if isinstance(x, list) and len(x) == 4
                                else _atd_bad_json("array of length 4", x)
                            )
                    ...
                    Switch(
                        (
                            lambda x: (
                                (
                                    Tok.from_json(x[0]),
                                    _atd_read_nullable(Condition.from_json)(x[1]),
                                    _atd_read_list(CaseAndBody.from_json)(x[2]),
                                )
                                if isinstance(x, list) and len(x) == 3
                                else _atd_bad_json("array of length 3", x)
                            )
            ...
            if cons == "Label":
                return cls(
                    Label_(
                        (
                            lambda x: (
                                (Label.from_json(x[0]), Stmt.from_json(x[1]))
                                if isinstance(x, list) and len(x) == 2
                                else _atd_bad_json("array of length 2", x)
                            )
                        )(x[1])
            ...
            if cons == "Goto":
                return cls(
                    Goto(
                        (
                            lambda x: (
                                (Tok.from_json(x[0]), Label.from_json(x[1]))
                                if isinstance(x, list) and len(x) == 2
                                else _atd_bad_json("array of length 2", x)
                            )
                        )(x[1])
                        ...
                        (
                            lambda x: (
                                (
                                    Tok.from_json(x[0]),
                                    Stmt.from_json(x[1]),
                                    _atd_read_list(Catch.from_json)(x[2]),
                                    _atd_read_nullable(Finally.from_json)(x[3]),
                                )
                                if isinstance(x, list) and len(x) == 4
                                else _atd_bad_json("array of length 4", x)
                            )
            ...
            if cons == "TyApply":
                return cls(
                    TyApply(
                        (
                            lambda x: (
                                (Type.from_json(x[0]), TypeArguments.from_json(x[1]))
                                if isinstance(x, list) and len(x) == 2
                                else _atd_bad_json("array of length 2", x)
                            )
                        )(x[1])
                ...
                return cls(
                    TyFun(
                        (
                            lambda x: (
                                (
                                    _atd_read_list(Parameter.from_json)(x[0]),
                                    Type.from_json(x[1]),
                                )
                                if isinstance(x, list) and len(x) == 2
                                else _atd_bad_json("array of length 2", x)
                ...
                return cls(
                    TyArray(
                        (
                            lambda x: (
                                (
                                    ExprNullableBracket.from_json(x[0]),
                                    Type.from_json(x[1]),
                                )
                                if isinstance(x, list) and len(x) == 2
                                else _atd_bad_json("array of length 2", x)
            ...
            if cons == "TyPointer":
                return cls(
                    TyPointer(
                        (
                            lambda x: (
                                (Tok.from_json(x[0]), Type.from_json(x[1]))
                                if isinstance(x, list) and len(x) == 2
                                else _atd_bad_json("array of length 2", x)
                            )
                        )(x[1])
            ...
            if cons == "TyQuestion":
                return cls(
                    TyQuestion(
                        (
                            lambda x: (
                                (Type.from_json(x[0]), Tok.from_json(x[1]))
                                if isinstance(x, list) and len(x) == 2
                                else _atd_bad_json("array of length 2", x)
                            )
                        )(x[1])
                ...
                return cls(
                    TyRecordAnon(
                        (
                            lambda x: (
                                (
                                    ClassKindWrap.from_json(x[0]),
                                    FieldListBracket.from_json(x[1]),
                                )
                                if isinstance(x, list) and len(x) == 2
                                else _atd_bad_json("array of length 2", x)
                            )
...
class TypeDefinition:
    ...
    def from_json(cls, x: Any) -> "TypeDefinition":
        if isinstance(x, dict):
            return cls(
                tbody=(
                    TypeDefinitionKind.from_json(x["tbody"])
                    if "tbody" in x
                    else _atd_missing_json_field("TypeDefinition", "tbody")
                ),
            )
        else:
...
class TypeDefinitionKind:
    ...
    value: Union[
        OrType, AndType, AliasType, NewType, AbstractType, Exception, OtherTypeKind
    ]
...
class TypeParameterClassic:
    ...
    def from_json(cls, x: Any) -> "TypeParameterClassic":
        if isinstance(x, dict):
            return cls(
                tp_id=(
                    Ident.from_json(x["tp_id"])
                    if "tp_id" in x
                    else _atd_missing_json_field("TypeParameterClassic", "tp_id")
                ),
                tp_attrs=(
                    _atd_read_list(Attribute.from_json)(x["tp_attrs"])
                    if "tp_attrs" in x
                    else _atd_missing_json_field("TypeParameterClassic", "tp_attrs")
                ),
                tp_bounds=(
                    _atd_read_list(Type.from_json)(x["tp_bounds"])
                    if "tp_bounds" in x
                    else _atd_missing_json_field("TypeParameterClassic", "tp_bounds")
                ),
                tp_default=(
                    _atd_read_nullable(Type.from_json)(x["tp_default"])
                    if "tp_default" in x
                    else _atd_missing_json_field("TypeParameterClassic", "tp_default")
                ),
                tp_variance=(
                    _atd_read_nullable(VarianceWrap.from_json)(x["tp_variance"])
                    if "tp_variance" in x
                    else _atd_missing_json_field("TypeParameterClassic", "tp_variance")
                ),
            )
        else:
    ...
    def to_json(self) -> Any:
        ...
        res["tp_default"] = _atd_write_nullable((lambda x: x.to_json()))(
            self.tp_default
        )
        res["tp_variance"] = _atd_write_nullable((lambda x: x.to_json()))(
            self.tp_variance
        )
        return res
...
class Xml:
    ...
    def from_json(cls, x: Any) -> "Xml":
        if isinstance(x, dict):
            return cls(
                xml_kind=(
                    XmlKind.from_json(x["xml_kind"])
                    if "xml_kind" in x
                    else _atd_missing_json_field("Xml", "xml_kind")
                ),
                xml_attrs=(
                    _atd_read_list(XmlAttribute.from_json)(x["xml_attrs"])
                    if "xml_attrs" in x
                    else _atd_missing_json_field("Xml", "xml_attrs")
                ),
                xml_body=(
                    _atd_read_list(XmlBody.from_json)(x["xml_body"])
                    if "xml_body" in x
                    else _atd_missing_json_field("Xml", "xml_body")
                ),
            )
        else:
            _atd_bad_json("Xml", x)
